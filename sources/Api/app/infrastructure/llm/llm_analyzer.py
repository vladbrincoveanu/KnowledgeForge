...
from ..domain.models import ConnectionType, LLMAnalysisResult
    ...
    def _parse_llm_response(
        ...
        try:
            ...
            return LLMAnalysisResult(
                ...
                suggested_join_strategy=parsed.get(
                    "suggested_join_strategy", "inner_join"
                ),
...
class FallbackAnalyzer:
    ...
    def _determine_connection_type(self, col1: str, col2: str) -> ConnectionType:
        ...
        if (
            "date" in col1_lower
            or "time" in col1_lower
            or "date" in col2_lower
            or "time" in col2_lower
        ):
            return ConnectionType.TEMPORAL

        if (
            "location" in col1_lower
            or "address" in col1_lower
            or "location" in col2_lower
            or "address" in col2_lower
        ):
    ...
    def _generate_business_context(self, col1: str, col2: str) -> str:
        ...
        return "These columns may enable linking data across different business processes, allowing for comprehensive analysis and insights."
