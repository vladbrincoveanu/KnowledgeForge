        ...
        return {
            ...
            "extraction_metrics": {
                **extraction_metrics,
                ...
                "total_relationships_discovered": system_metrics.get("total_relationships", 0)
            },
            "quality_metrics": {
        ...
        try:
            with neo4j_manager:
                ...
                detailed_status["neo4j"] = {
                    "status": "healthy",
                    "connection_pool_size": pool_info.size if hasattr(pool_info, 'size') else "unknown",
                    "active_connections": pool_info.in_use if hasattr(pool_info, 'in_use') else "unknown",
