...
class TestAgricultureWorkersExtraction:
    ...
    def __init__(self):
        ...
        self.csv_path = Path(__file__).parent.parent / "data" / "sample-data" / "agriculture_workers_percent_of_employment.csv"
    ...
    def test_file_upload_and_extraction(self):
        ...
        try:
            ...
            extraction_response = requests.post(f"{self.base_url}/api/v1/extract/", json={
                "file_path": file_path,
                "extraction_config": {
            ...
            results_response = requests.get(f"{self.base_url}/api/v1/extract/{task_id}/results")
    ...
    def test_data_profiling(self):
        ...
        try:
            ...
            profile_response = requests.post(f"{self.base_url}/api/v1/data/profile", json={
                "file_path": file_path
            })
