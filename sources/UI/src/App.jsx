...
import { Database, Activity, Upload, BarChart3, Settings, Home, Brain } from 'lucide-react';
import './App.css';

// Navigation component
const Navigation = ({ activeTab }) => {
  const navItems = [
    { id: 'upload', label: 'Upload & Extract', icon: <Upload size={20} />, path: '/' },
    { id: 'results', label: 'Ontology Results', icon: <Database size={20} />, path: '/results' },
    { id: 'graph', label: 'Graph View', icon: <BarChart3 size={20} />, path: '/graph' },
    { id: 'metrics', label: 'System Metrics', icon: <Activity size={20} />, path: '/metrics' },
...
const MainContent = () => {
  ...
  const handleExtractionStarted = useCallback((taskId, file) => {
    setExtractionTasks(prev => ({
      ...prev,
      [taskId]: {
        taskId,
  ...
  const loadGraphData = async (taskId) => {
    try {
      const graphData = await ontologyAPI.getGraphVisualization(taskId);
  ...
  const handleFeedbackSubmitted = useCallback((feedback) => {
          ...
          <Routes>
            <Route path="/" element={
              <div className="upload-section">
                <div className="section-header">
                  <h1><Upload size={32} /> Upload & Extract Ontology</h1>
                  <p>Upload CSV files and extract semantic ontology using AI-powered analysis</p>
                </div>
            ...
            <Route path="/results" element={
              <div className="results-section">
                <div className="section-header">
                  <h1><Database size={32} /> Ontology Results</h1>
                  <p>View extracted entities, relationships, and provide feedback</p>
                </div>
                ...
                {activeTaskId ? (
                  ...
                  <div className="no-task-selected">
                    ...
                    <p>Upload files and start ontology extraction to see results here.</p>
                  </div>
                )}
              </div>
            } />
            ...
            <Route path="/graph" element={
              <div className="graph-section">
                <div className="section-header">
                  <h1><BarChart3 size={32} /> Graph Visualization</h1>
                  <p>Interactive visualization of extracted ontology relationships</p>
                </div>
            ...
            <Route path="/metrics" element={
              <div className="metrics-section">
                <div className="section-header">
                  <h1><Activity size={32} /> System Metrics</h1>
                  <p>Monitor system performance, health, and extraction metrics</p>
                </div>
                ...
                <div className="settings-content">
                  <div className="setting-group">
                    ...
                    <div className="setting-item">
                      ...
                      <input 
                        type="password" 
                        defaultValue={import.meta.env.VITE_API_KEY || 'test-api-key-12345'}
                        placeholder="API key"
                      />
                    </div>
                  </div>
