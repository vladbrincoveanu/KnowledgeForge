...
interface ConnectionPromptProps {
  ...
  onResponse: (accepted: boolean, connection: Connection) => void;
  onClose?: () => void;
}
...
const ConnectionPrompt: React.FC<ConnectionPromptProps> = ({
  ...
  const _getConfidenceLabel = (confidence: number): string => {
    ...
    <div className="connection-prompt-overlay" onClick={handleClose}>
      <div className="connection-prompt" onClick={e => e.stopPropagation()}>
        ...
        <div className="prompt-header">
          <div className="header-content">
            ...
            <div
              ...
              style={{
                backgroundColor: getConfidenceColor(connection.confidence),
              }}
            >
        ...
        <div className="prompt-content">
          ...
          <div className="discovery-highlight">
            ...
            <div className="highlight-content">
              ...
              <p>
                Our AI analyzed your data files and discovered this potential
                connection. Review the analysis below and validate with a single
                click.
              </p>
            </div>
          </div>
          ...
          {connection.llmAnalysis && (
            <div className="ai-analysis-section">
              ...
              <div className="analysis-grid">
                ...
                <div className="analysis-card">
                  ...
                  <div className="type-badge">
                    {connection.llmAnalysis.connection_type || 'FOREIGN KEY'}
                  </div>
                </div>
                ...
                <div className="analysis-card">
                  ...
                  <div className="strategy-badge">
                    {connection.llmAnalysis.suggested_join_strategy ||
                      'inner join'}
                  </div>
                </div>
              </div>
              ...
              {/* Potential Issues */}
              {connection.llmAnalysis.potential_issues &&
                connection.llmAnalysis.potential_issues.length > 0 && (
                  <div className="issues-section">
                    <h4>⚠️ Potential Issues</h4>
                    <ul>
                      {connection.llmAnalysis.potential_issues.map(
                        (issue, index) => (
              ...
              {/* Recommendations */}
              {connection.llmAnalysis.recommendations &&
                connection.llmAnalysis.recommendations.length > 0 && (
                  <div className="recommendations-section">
                    <h4>💡 Recommendations</h4>
                    <ul>
                      {connection.llmAnalysis.recommendations.map(
                        (rec, index) => (
                          <li key={index}>{rec}</li>
                        )
                      )}
          ...
          <div className="action-question">
            <p>
              ...
              <span className="highlight">
                Click &quot;Yes&quot; to create the connection
              </span>{' '}
        ...
        <div className="prompt-help">
          <small>
            💡 <strong>Tip:</strong> The AI analyzes column names, data types,
            and patterns to suggest connections. You can always review and
            modify connections later. Press <kbd>Esc</kbd> to close.
          </small>
        </div>
      </div>
    </div>
