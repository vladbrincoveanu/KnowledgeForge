...
## Related Skills
- **multi-architect** - For launching multi-architect teams with Leader + Business Analyst + Architects
- **orchestration** - For coordination patterns and phase handoffs between agents
- **self-improving-agent** - For curating agent patterns into project memory
- **mcp-server-builder** - For building MCP servers that agents can use as tools
- **skill-security-auditor** - For auditing agent tools and workflows for security risks
