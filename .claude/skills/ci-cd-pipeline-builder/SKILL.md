...
## Related Skills
- **database-designer** - For database migration integration in CI/CD
- **mcp-server-builder** - For MCP server deployment pipelines
- **playwright-pro** - For E2E test integration in CI/CD
- **skill-security-auditor** - For security scanning in CI/CD gates
- **multi-agent-code-review** - For comprehensive pre-deploy code review
