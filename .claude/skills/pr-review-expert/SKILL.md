...
## Related Skills
- **code-reviewer** - For automated code quality checking and SOLID violations
...
- **playwright-pro** - For E2E test coverage analysis
- **pr-review-expert** - For PR-specific blast radius and ticket linking
