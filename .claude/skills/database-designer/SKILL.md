...
## Related Skills
- **ci-cd-pipeline-builder** - For database migration integration in CI/CD
- **mcp-server-builder** - For building MCP servers that expose database tools to agents
- **pr-review-expert** - For reviewing database migration impact in PRs
- **agent-designer** - For designing multi-agent systems that interact with databases
