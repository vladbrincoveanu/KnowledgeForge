...
## Related Skills
- **ci-cd-pipeline-builder** - For integrating Playwright into CI/CD pipelines
- **code-reviewer** - For code quality and SOLID violation detection
- **self-improving-agent** - For curating test patterns into project memory
- **multi-agent-code-review** - For comprehensive review including E2E testing
