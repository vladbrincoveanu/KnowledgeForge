...
## Related Skills
- **pr-review-expert** - For PR-specific blast radius and breaking change detection
- **playwright-pro** - For E2E test coverage and browser automation
- **skill-security-auditor** - For deep security vulnerability scanning
- **multi-agent-code-review** - For running 6 agents in parallel for comprehensive review
- **ci-cd-pipeline-builder** - For CI/CD pipeline integration with testing
