...
`;
  ...
  var _3dForceGraphAr = index$1({
    ...
    update: function update(state, changedProps) {
      ...
      changedProps.hasOwnProperty('glScale') && state.forcegraph.setAttribute('scale', _toConsumableArray$2(new Array(3)).map(function () {
      ...
      var newProps = Object.assign.apply(Object, [{}].concat(_toConsumableArray$2(Object.entries(state).filter(function (_ref5) {
      ...
      })), _toConsumableArray$2(Object.entries(state.graphData).map(function (_ref0) {
        var _ref1 = _slicedToArray$3(_ref0, 2),
          key = _ref1[0],
          val = _ref1[1];
        return _defineProperty$1({}, key, val);
      }))));
